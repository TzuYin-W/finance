  ...
  function renderCash(){
    ...
    return `<div class="page-stack">
      ...
      <section class="card" id="cashTransactionList">
        ...
        <div class="table-wrap cash-transactions-wrap"><table class="data-table cash-transactions-table fit-table"><thead><tr><th class="cash-select-col" title="全選目前篩選結果"><input class="cash-bulk-check" type="checkbox" data-bulk-cash-select-all ${allFilteredSelected?'checked':''} aria-label="全選目前篩選結果"></th><th class="date-col">日期</th><th>科目</th><th class="description-col">描述</th><th class="numeric">金額</th><th>帳戶</th><th><span class="desktop-label">月報處理</span><span class="mobile-label">月報</span></th><th class="row-color-cell">顏色</th><th><span class="mobile-label">刪</span></th></tr></thead><tbody>
  ...
  function renderCredit(){
    ...
    return `<div class="page-stack">
      ...
      <section class="card">
        ...
        <div class="table-wrap credit-transactions-wrap"><table class="data-table credit-transactions-table fit-table"><thead><tr><th class="date-col">日期</th><th class="description-col">描述</th><th class="numeric">金額</th><th class="store-col"><span class="desktop-label">商店名稱</span><span class="mobile-label">商店</span></th><th>卡片</th><th class="numeric"><span class="desktop-label">交易手續費</span><span class="mobile-label">費</span></th><th><span class="desktop-label">統計</span><span class="mobile-label">統計</span></th><th class="paid-col" title="全選目前篩選結果"><input class="paid-check" type="checkbox" data-bulk-paid="${ui.activeCard}" ${allFilteredPaid?'checked':''} aria-label="全選已繳"></th><th class="numeric"><span class="desktop-label">未繳累計</span><span class="mobile-label">未繳</span></th><th><span class="mobile-label">刪</span></th></tr></thead><tbody>
